    ...
    <footer className="bg-gray-50 py-12 border-t border-gray-200">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="font-bold text-lg mb-4">Eureka</h3>
            <p className="text-gray-600 mb-4">
              Secure document stamping powered by blockchain technology.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/pdf-stamping" className="text-gray-600 hover:text-blue-600">PDF Stamping</Link></li>
              <li><Link href="/verification" className="text-gray-600 hover:text-blue-600">Document Verification</Link></li>
              <li><Link href="/api" className="text-gray-600 hover:text-blue-600">API Access</Link></li>
              <li><Link href="/enterprise" className="text-gray-600 hover:text-blue-600">Enterprise Solutions</Link></li>
            </ul>
          </div>
